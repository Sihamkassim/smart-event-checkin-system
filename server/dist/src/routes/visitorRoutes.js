 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:eventId/visitors', visitorController_1.getVisitors);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:eventId/visitors/search', visitorController_1.searchVisitors);
/**
 * @swagger
 * /api/visitors/{eventId}/visitors:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/:eventId/visitors', visitorController_1.createVisitor);
/**
 * @swagger
 * /api/visitors/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:id', visitorController_1.updateVisitor);
/**
 * @swagger
 * /api/visitors/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', (0, auth_1.authorize)('admin'), visitorController_1.deleteVisitor);
